...
public class RegistryProtocol implements Protocol {
    ...
    private <T> Invoker<T> doRefer(Cluster cluster, Registry registry, Class<T> type, URL url) {
        ...
        URL subscribeUrl = new URL(Constants.CONSUMER_PROTOCOL, NetUtils.getLocalHost(), 0, directory.getUrl().getParameter(Constants.INTERFACE_KEY), directory.getUrl().getParameters());
